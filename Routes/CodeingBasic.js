...
router.post("/addbasic/:subjectId/:chapterId", async (req, res) => {
  try {
    ...
    return res.json({
      msg: "Coding Basic added successfully",
      status: "success",
    });
  } catch (error) {
...
router.put(
  "/:subjectId/chapters/:chapterId/codingbasic/:codingbasicId",
  async (req, res) => {
    try {
      const subjectId = req.params.subjectId;
      const chapterId = req.params.chapterId;
      ...
      if (!codingbasicEntry) {
        return res
          .status(404)
          .json({ msg: "Coding Basic entry not found", status: "failed" });
      }
      ...
      return res.json({
        msg: "Coding Basic updated successfully",
        status: "success",
      });
    } catch (error) {
...
router.get(
  "/getbasic/:subjectId/:chapterId/:codingBasicId",
  async (req, res) => {
    try {
      // Extract parameters
      const subjectId = req.params.subjectId;
...
router.delete(
  "/deletebasic/:subjectId/:chapterId/:codingBasicId",
  async (req, res) => {
    try {
      // Extract parameters
      const subjectId = req.params.subjectId;
      ...
      return res.json({
        msg: "Coding Basic entry deleted successfully",
        status: "success",
      });
    } catch (error) {
